...
Constraint_A::Constraint_A(void) : Constraint() {}

Constraint_A::Constraint_A(const Constraint_A &from) : Constraint(from) {}
...
std::string Constraint_A::class_name(void) { return "Constraint_A"; }
