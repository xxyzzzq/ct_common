...
std::string Exp_A_Neg::class_name(void) {
  return "Exp_A_Neg";
}

double Exp_A_Neg::evaluate_double(double val) const {
  return -val;
}

int Exp_A_Neg::evaluate_int(int val) const {
  return -val;
}

std::string Exp_A_Neg::get_op_token(void) const {
  return "-";
}
