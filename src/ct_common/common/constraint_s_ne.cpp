...
Constraint_S_NE::Constraint_S_NE(void) : Constraint_S_Binary() {}
...
std::string Constraint_S_NE::class_name(void) { return "Constraint_S_NE"; }

bool Constraint_S_NE::evaluate_func(const std::string &val_1,
                                    const std::string &val_2) const {
  return val_1 != val_2;
}

std::string Constraint_S_NE::get_op_token(void) const { return "!="; }
