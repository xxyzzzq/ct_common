...
Constraint_A_LE::Constraint_A_LE(void) : Constraint_A_Binary() {}
...
std::string Constraint_A_LE::class_name(void) { return "Constraint_A_LE"; }
...
bool Constraint_A_LE::evaluate_func_double(double loprd_val,
                                           double roprd_val) const {
  return ct::common::utils::cmp_le(loprd_val, roprd_val, this->precision_);
}

std::string Constraint_A_LE::get_op_token(void) const { return "<="; }
