...
Exp_A_Div::Exp_A_Div(void) : Exp_A_Binary() {}

Exp_A_Div::Exp_A_Div(const Exp_A_Div &from) : Exp_A_Binary(from) {}
...
std::string Exp_A_Div::class_name(void) { return "Exp_A_Div"; }
...
std::string Exp_A_Div::get_op_token(void) const { return "/"; }
