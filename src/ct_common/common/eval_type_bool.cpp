...
EvalType_Bool::EvalType_Bool(void) : EvalType() { this->value_ = false; }

EvalType_Bool::EvalType_Bool(bool value, bool is_valid) : EvalType(is_valid) {
  this->value_ = value;
}

EvalType_Bool::EvalType_Bool(const EvalType_Bool &from) : EvalType(from) {
