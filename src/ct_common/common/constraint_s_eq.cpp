...
Constraint_S_EQ::Constraint_S_EQ(void) : Constraint_S_Binary() {}
...
std::string Constraint_S_EQ::class_name(void) { return "Constraint_S_EQ"; }

bool Constraint_S_EQ::evaluate_func(const std::string &val_1,
                                    const std::string &val_2) const {
  return val_1 == val_2;
}

std::string Constraint_S_EQ::get_op_token(void) const { return "=="; }
