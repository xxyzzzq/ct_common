...
//===----------------------------------------------------------------------===//
//
// This file contains the function definitions of class Exp_A
//
//===----------------------------------------------------------------------===//
...
Exp_A::Exp_A(void) : Exp(), type_(EAT_INT) {}

Exp_A::Exp_A(const Exp_A &from) : Exp(from), type_(from.type_) {}
...
std::string Exp_A::get_class_name(void) const { return Exp_A::class_name(); }

std::string Exp_A::class_name(void) { return "Exp_A"; }

EvalType_Double Exp_A::EvaluateDouble(
...
EvalType_Int Exp_A::EvaluateInt(
    const std::vector<std::shared_ptr<ParamSpec> > &param_specs,
    const Assignment &assignment) const {
