...
Constraint_A_GE::Constraint_A_GE(void) : Constraint_A_Binary() {}
...
std::string Constraint_A_GE::class_name(void) { return "Constraint_A_GE"; }
...
bool Constraint_A_GE::evaluate_func_double(double loprd_val,
                                           double roprd_val) const {
  return ct::common::utils::cmp_ge(loprd_val, roprd_val, this->precision_);
}

std::string Constraint_A_GE::get_op_token(void) const { return ">="; }
