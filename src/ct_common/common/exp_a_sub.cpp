...
Exp_A_Sub::Exp_A_Sub(void) : Exp_A_Binary() {}

Exp_A_Sub::Exp_A_Sub(const Exp_A_Sub &from) : Exp_A_Binary(from) {}
...
std::string Exp_A_Sub::class_name(void) { return "Exp_A_Sub"; }
...
std::string Exp_A_Sub::get_op_token(void) const { return "-"; }
