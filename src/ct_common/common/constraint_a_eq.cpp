...
Constraint_A_EQ::Constraint_A_EQ(void) : Constraint_A_Binary() {}

Constraint_A_EQ::Constraint_A_EQ(const Constraint_A_EQ &from)
    : Constraint_A_Binary(from) {}

Constraint_A_EQ &Constraint_A_EQ::operator=(const Constraint_A_EQ &right) {
...
std::string Constraint_A_EQ::class_name(void) { return "Constraint_A_EQ"; }
...
bool Constraint_A_EQ::evaluate_func_double(double loprd_val,
                                           double roprd_val) const {
  return ct::common::utils::cmp_eq(loprd_val, roprd_val, this->precision_);
}

std::string Constraint_A_EQ::get_op_token(void) const { return "=="; }
