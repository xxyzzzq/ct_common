...
Exp_A_CDouble::Exp_A_CDouble(void) : Exp_A_Atom(), value_(0), str_value_() {}
...
void Exp_A_CDouble::set_value(int value) { this->value_ = value; }

void Exp_A_CDouble::set_value(double value) { this->value_ = value; }

EvalType_Double Exp_A_CDouble::EvaluateDouble_Impl(
    const std::vector<std::shared_ptr<ParamSpec> > &param_specs,
    const Assignment &assignment) const {
  return EvalType_Double(this->value_, true);
}

EvalType_Int Exp_A_CDouble::EvaluateInt_Impl(
    const std::vector<std::shared_ptr<ParamSpec> > &param_specs,
    const Assignment &assignment) const {
...
std::string Exp_A_CDouble::class_name(void) { return "Exp_A_CDouble"; }
