//===----- ct_common/common/constraint_l_and.cpp ----------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the function definitions of class Constraint_L_And
//
//===----------------------------------------------------------------------===//
...
Constraint_L_And::Constraint_L_And(void) : Constraint_L_Binary() {}
...
std::string Constraint_L_And::class_name(void) { return "Constraint_L_And"; }

EvalType_Bool Constraint_L_And::evaluate_func(EvalType_Bool val_l,
...
std::string Constraint_L_And::get_op_token(void) const { return "&&"; }
