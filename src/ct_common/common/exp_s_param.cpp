...
Exp_S_Param::Exp_S_Param(void) : Exp_S_Atom(), pid_(PID_BOUND) {}
...
EvalType_String Exp_S_Param::Evaluate(
  ...
  if (tmp_return.is_valid_) {
    tmp_return.value_ =
        dynamic_cast<ParamSpec_String *>(param_specs[this->pid_].get())
...
std::string Exp_S_Param::class_name(void) { return "Exp_S_Param"; }
