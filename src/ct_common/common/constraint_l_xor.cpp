...
Constraint_L_Xor::Constraint_L_Xor(void) : Constraint_L_Binary() {}
...
std::string Constraint_L_Xor::class_name(void) { return "Constraint_L_Xor"; }

EvalType_Bool Constraint_L_Xor::evaluate_func(EvalType_Bool val_l,
...
std::string Constraint_L_Xor::get_op_token(void) const { return "^^"; }
