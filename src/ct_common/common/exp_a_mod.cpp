...
Exp_A_Mod::Exp_A_Mod(void) : Exp_A_Binary() {}

Exp_A_Mod::Exp_A_Mod(const Exp_A_Mod &from) : Exp_A_Binary(from) {}
...
std::string Exp_A_Mod::class_name(void) { return "Exp_A_Mod"; }
...
std::string Exp_A_Mod::get_op_token(void) const { return "%"; }
