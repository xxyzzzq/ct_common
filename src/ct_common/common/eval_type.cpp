...
EvalType::EvalType(void) : is_valid_(false) {}

EvalType::EvalType(bool is_valid) : is_valid_(is_valid) {}

EvalType::EvalType(const EvalType &from) : is_valid_(from.is_valid_) {}
