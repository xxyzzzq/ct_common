...
Constraint_A_GT::Constraint_A_GT(void) : Constraint_A_Binary() {}

Constraint_A_GT::Constraint_A_GT(const Constraint_A_GT &from)
    : Constraint_A_Binary(from) {}

Constraint_A_GT &Constraint_A_GT::operator=(const Constraint_A_GT &right) {
...
std::string Constraint_A_GT::class_name(void) { return "Constraint_A_GT"; }
...
bool Constraint_A_GT::evaluate_func_double(double loprd_val,
                                           double roprd_val) const {
  return ct::common::utils::cmp_gt(loprd_val, roprd_val, this->precision_);
}

std::string Constraint_A_GT::get_op_token(void) const { return ">"; }
