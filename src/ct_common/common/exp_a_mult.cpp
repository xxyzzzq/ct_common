...
Exp_A_Mult::Exp_A_Mult(void) : Exp_A_Binary() {}

Exp_A_Mult::Exp_A_Mult(const Exp_A_Mult &from) : Exp_A_Binary(from) {}
...
std::string Exp_A_Mult::class_name(void) { return "Exp_A_Mult"; }
...
std::string Exp_A_Mult::get_op_token(void) const { return "*"; }
