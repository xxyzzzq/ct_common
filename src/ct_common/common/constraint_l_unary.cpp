...
Constraint_L_Unary::Constraint_L_Unary(void) : Constraint_L() {
...
Constraint_L_Unary &Constraint_L_Unary::operator=(
    const Constraint_L_Unary &right) {
...
EvalType_Bool Constraint_L_Unary::Evaluate(
    const std::vector<std::shared_ptr<ParamSpec> > &param_specs,
    const Assignment &assignment) const {
  EvalType_Bool tmp_return =
      this->get_oprd()->Evaluate(param_specs, assignment);
